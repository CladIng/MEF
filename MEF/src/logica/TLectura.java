...
public class TLectura {
    ...
    /**
     * Define si la prueba en cuestión esta o no terminado
     * @param test
     * @param parm1
     * @param parm2
     * @return
    ...
    /**
     * 
     * @return El nombre de todos los ensayos 
     */
     ...
     * 
     * @param name
     * @return ArrayList con todos los ciclos y fuerzas de un ensayo
     * @throws IOException 
     */
    ...
    /**
     * 
     * @return todos los ensayos no terminados
     * @throws IOException 
     */
    ...
    /**
     * Retorna un ArryList con datos de la ultima prueba
     * @param name
     * @return
     * @throws IOException 
     */
     ...
     * 
     * @param file
     * @return Lee una prueba determinada y retorna unArryList con su información
     * @throws IOException 
     */
