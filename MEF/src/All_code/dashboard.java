...
public class dashboard extends javax.swing.JFrame {
    ...
    /**
     * Evento Escuchador de los datos recibidos del Arduino
     */
    SerialPortEventListener evento = new SerialPortEventListener() {
        ...
        public void serialEvent(SerialPortEvent spe) {
            if(arduino.isMessageAvailable()){
                ...
                if (Sensores[1].equals("null")) {
                    tfFuerza.setText(Sensores[0]);
                }else{
                    ciclos += Integer.parseInt(Sensores[1]);
                    tfFuerza.setText(Sensores[0]);
                    tfCiclos.setText(ciclos+"");
    ...
    /**
     * Iniciar conexion con el Arduino
     */
    ...
    /**
     * Enviar para información al Arduino
     * @param evt 
     */
    ...
    /**
     * Parar la recepción de informacion del Arduino
     * @param evt 
     */
